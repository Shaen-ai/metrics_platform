    ...
    <div className="relative min-h-screen flex items-center justify-center bg-[var(--background)] p-4">
      ...
      <Card className="w-full max-w-md rounded-2xl border-[var(--border)] shadow-sm">
        <CardHeader className="items-center text-center">
          ...
          <CardTitle className="text-2xl text-[var(--foreground)]">{t("auth.forgotPasswordTitle")}</CardTitle>
        ...
        <CardContent>
          {sent ? (
            <div className="space-y-4 text-center">
              <p className="text-sm text-[var(--foreground)] bg-[#E8F5E9] border border-[#C8E6C9] p-3 rounded-lg">
