    ...
    <div className="relative flex min-h-screen items-center justify-center bg-[var(--background)] p-4">
      ...
      <Card className="w-full max-w-md rounded-2xl border-[var(--border)] shadow-sm">
        <CardHeader className="items-center text-center">
          ...
          <CardTitle className="text-2xl text-[var(--foreground)]">{t("auth.createAccount")}</CardTitle>
        ...
        <CardContent>
          {emailSent ? (
            <div className="space-y-4 text-center">
              <p className="rounded-lg border border-[#C8E6C9] bg-[#E8F5E9] p-4 text-sm text-[var(--foreground)]">
